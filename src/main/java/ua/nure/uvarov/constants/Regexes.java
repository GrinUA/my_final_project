...
public class Regexes {
    ...
    public static final Pattern BOOK_STRING_PATTERN = Pattern.compile("^[ a-zA-Z0-9а-яА-Я]{1,50}$");
    public static final Pattern BOOK_GENRE_PATTERN = Pattern.compile("^[0-9]{1,16}$");
}

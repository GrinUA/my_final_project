...
public final class MySQL {
    ...
    public static final String FIND_BOOK_GROUPS_GENRE = "SELECT * FROM book_groups WHERE id = ?";
   ...
   // public static final String BOOK_AVAILABLE_STATUS = "SELECT unavailable FROM books WHERE id = ?";
    ...
    public static final String CREATE_BOOK_GROUP = "INSERT into book_groups (id,name,author,edition,publicationDate,genreId,price) " +
            "values (?,?,?,?,?,?,?)";
